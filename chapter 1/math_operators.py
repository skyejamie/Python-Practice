...
a = 4
o = 2
print(-l + m + a + o) # (the 9 in the "l" variable turns into a -9 because the "-" sign is in front of said variable in the print function) adds them all and prints the result
